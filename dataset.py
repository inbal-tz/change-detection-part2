...
class idd_lite(Dataset):
    ...
    def __init__(self, root, co_transform=None, subset='train'):
        ...
        # if subset == 'train':
        #     self.filenames = self.get_balanced_dataBase(800, os.path.join(self.images_root, 'A'), self.labels_root)
        #     self.filenames1 = self.get_balanced_dataBase(800, os.path.join(self.images_root, 'B'), self.labels_root)
        #     self.filenamesGt = self.get_balanced_dataBase(800, self.labels_root, self.labels_root)
        # if subset == 'test':
        #     self.filenames = self.get_balanced_dataBase(500, os.path.join(self.images_root, 'A'), self.labels_root)
        #     self.filenames1 = self.get_balanced_dataBase(500, os.path.join(self.images_root, 'B'), self.labels_root)
        #     self.filenamesGt = self.get_balanced_dataBase(500, self.labels_root, self.labels_root)
